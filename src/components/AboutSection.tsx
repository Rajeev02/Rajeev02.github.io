        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="glass-card p-5 sm:p-8 md:p-12">
            <div className="space-y-4 sm:space-y-6 text-base sm:text-lg text-muted-foreground leading-relaxed">
              ...
              <p>
                With <span className="text-foreground font-semibold">9+ years</span> of experience, I have shipped secure, scalable mobile products across fintech, student housing, travel, and consumer platforms — with <span className="text-primary">7 apps on the Play Store</span> and <span className="text-primary">4 on the App Store</span>, owning delivery, releases, and production support.
              </p>
              <p>
