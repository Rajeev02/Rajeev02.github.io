      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-sm sm:text-base md:text-lg text-primary font-medium mb-6 sm:mb-8 animate-fade-up opacity-0 delay-300 px-2">
            Mobile Engineer · Cross-platform Android &amp; iOS · Fintech · Student Housing
          </p>
          ...
          <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-2 sm:gap-4 mb-8 sm:mb-10 animate-fade-up opacity-0 delay-400">
            ...
            <a href="tel:+918792169096" className="flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors text-sm sm:text-base">
              <Phone className="w-4 h-4 text-primary flex-shrink-0" />
              <span>+91 8792169096</span>
            </a>
            <a href="mailto:rajeevjoshi91@gmail.com" className="flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors text-sm sm:text-base">
              <Mail className="w-4 h-4 text-primary flex-shrink-0" />
              <span className="break-all sm:break-normal">rajeevjoshi91@gmail.com</span>
            </a>
          </div>
          ...
          <div className="flex items-center justify-center gap-4 sm:gap-8 mb-8 sm:mb-10 animate-fade-up opacity-0 delay-400">
            ...
            <div className="text-center">
              ...
              <div className="text-xs sm:text-sm text-muted-foreground">Play Store Apps</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-primary">4</div>
              <div className="text-xs sm:text-sm text-muted-foreground">App Store Apps</div>
            </div>
          </div>
