...
const experiences = [
  {
    ...
    highlights: [
      "Owned and executed React Native version upgrades across multiple release cycles (0.63 through 0.83) by resolving dependency conflicts and platform deprecations, resulting in 99.9% crash-free sessions across production releases.",
      "Modernized the mobile platform by adopting the React Native New Architecture (Hermes, JSI, Fabric, TurboModules), improving app start-up time by 30% and optimizing JavaScript-to-Native bridge communication.",
      "Designed and built a reusable white-label application architecture from a single shared codebase, enabling rapid configuration and deployment of three distinct startup ecosystem products (LVX, LVXQ, Scalix) while decreasing duplicate development efforts by 50%.",
      "Automated Android and iOS build, test, and release pipelines using Fastlane and GitHub Actions, delivering over 60+ production releases and reducing deployment cycle times by 40%.",
      "Implemented offline-first caching mechanisms, background task synchronization, and network query optimization using React Query and Redux, resulting in a 35% reduction in API overhead and smooth offline operations.",
      "Secured user accounts and transactions by integrating OAuth, JWT, AWS Cognito, and Auth0 authentication protocols, alongside Razorpay and Cashfree payment gateways for seamless payment flows.",
      "Architected a modular feature-based folder structure implementing clean architecture and SOLID principles, which decoupled legacy modules and reduced overall bundle size by 20%.",
      "Developed and maintained native bridge integrations for critical services (Camera, GPS Location, Push Notifications, Deep Linking), ensuring high-fidelity hardware access on both iOS and Android.",
      "Structured and managed multiple environment profiles (Dev, QA, UAT, Staging, Prod) using unified configuration schemas, ensuring consistency and zero configuration leakage across release phases.",
      "Led technical planning sessions, coordinated with cross-functional teams (Product, Backend, QA), and mentored junior engineers, which accelerated sprint delivery velocity by 25%."
    ],
  },
  {
